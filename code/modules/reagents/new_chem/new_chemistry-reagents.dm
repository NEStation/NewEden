...
/* ELEMENTS */
		...
		vanadium
			name = "Vanadium"
			id = "vanadium"
			description = "A metal with a vendetta."
			reagent_state = SOLID
			color = "#C8A5DC"
...
/* Precursors and shit that nobody will really use outside synthesis */
		...
		acetylene
			name = "Acetylene"
			id = "acetylene"
			description = "A hydrocarbon, and the simplest alkyne. Often used in the production of welding fuel."
			reagent_state = GAS
			color = "#808080" // rgb: 128, 128, 128
		...
		sodium_hypochlorite
			...
			description = "The salt of hypochlorous acid. A key component in bleach."
			reagent_state = LIQUID
			color = "#808080" // rgb: 128, 128, 128
		...
		alunogen
			name = "Alunogen"
			id = "alunogen"
			description = "A needle-like aluminum mineral. Often contains impure aluminum-sulfate."
			reagent_state = LIQUID
			color = "#808080" // rgb: 128, 128, 128
		...
		glucose
			name = "Glucose"
			id = "glucose"
			description = "A sweet, simple sugar. The most basic carbohydrate."
			reagent_state = SOLID
			color = "#808080" // rgb: 128, 128, 128
		...
		fructose
			name = "Nitroglycerin"
			id = "nitroglycerin"
			description = "A simple sugar. Combines with glucose to form table sugar."
			reagent_state = LIQUID
			color = "#808080" // rgb: 128, 128, 128
		...
		silica
			name = "Silica"
			id = "silica"
			description = "Common sand. Also known as silicon dioxide."
			reagent_state = SOLID
			color = "#FFFFFF"
			overdose = REAGENTS_OVERDOSE
...
/* Misc Chems */
		...
		bz_78
			name = "BZ 78"
			id = "bz_78"
			description = "A powerful hallucinogen, confusion-agent, and involuntary stimulant."
			reagent_state = LIQUID
...
/* Medical Chems and non-toxin poisons */
		...
		//Secret chem - replaces tricord with something -slightly- more viable
		medellamniscine
			name = "Medellamniscine"
			id = "medellamniscine"
			description = "A classified concoction manufactured in the most clandestine of laboratories. Rumored to raise dead men, but that's preposterous."
			reagent_state = LIQUID
		...
		//FIX - fixes internal organs a little bit too
		mannitol
			name = "Mannitol"
			id = "mannitol"
		...
		//FIX - Functions like sotalol as well, and a tachycardic, and a nerve agent nullifyer.
		atropine
			name = "Atropine"
			id = "atropine"
			description = "A multi-use medication, affecting a wide range of symptoms, such as eye-damage and heart trauma."
			reagent_state = LIQUID
			color = "#C8A5DC" // rgb: 200, 165, 220
			overdose = REAGENTS_OVERDOSE
			scannable = 1
		...
		vx // Edit/fix/whatever
			name = "VX Agent"
			id = "vx"
			description = "A deadly neurotoxin. Lethal in small doses if not counteracted quickly."
			reagent_state = LIQUID
			color = "#C8A5DC" // rgb: 200, 165, 220
			overdose = REAGENTS_OVERDOSE
